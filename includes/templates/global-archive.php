...
$template_id = class_exists( 'ACZ_Theme_Options' ) ? ACZ_Theme_Options::get_global_archive_template_id() : 0;
...
if ( $template_id && class_exists( '\Elementor\Plugin' ) && isset( \Elementor\Plugin::$instance->frontend ) ) {
    ...
    if ( '' !== trim( $content ) ) {
        echo '<main class="acz-global-archive acz-global-template-shell is-loading" data-template-id="' . esc_attr( (string) $template_id ) . '">';
